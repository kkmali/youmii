  ...
  return (
    <div className={`flex flex-col gap-1.5${className ? ` ${className}` : ''}`}>
      ...
      <textarea
        ...
        className={`w-full bg-input-bg rounded-2xl px-3 sm:px-4 py-2 sm:py-2.5 text-sm text-body-text placeholder:text-secondary/60 transition-colors resize-none focus-visible:outline-2 focus-visible:bg-white${
          error
